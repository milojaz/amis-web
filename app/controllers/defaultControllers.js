...
module.exports = {
    // download FBO LIST get request
    downloadFBOList: (req, res, next) => {
        var filePath = "../data/"; // Or format the path using the `id` rest param
        var fileName = "ASMG_Beneficiaries_Database.xls"; // The default name the browser will use
