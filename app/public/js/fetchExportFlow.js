...
function getExportTradeFlowData() {
    ...
    rootRef.on("child_added", function(snap) {
        ...
        var fetchedDistrictFrom = snap.child("districtFrom").val();
        ...
        // console.log(fetchedDistrictFrom+ ' ' + fetchedWHS_Value);
        ...
        var cellText_9 = document.createTextNode(fetchedDistrictFrom);
